 ...
 "$Header: /home/pcrtree/SRC.RCS/libs/csf/RCS/mopen.c,v 2.1 1996/12/29 19:35:21 cees Exp $";
#endif
	...
	enum MOPEN_PERM mode) /*  file permission */
{
 ...
 m->read((void *)&(m->raster.cellSizeX), sizeof(REAL8),1,m->fp);
 m->read((void *)&(m->raster.cellSizeY), sizeof(REAL8),1,m->fp);
  ...
  */
 if(strncmp(m->main.signature,SIG,SIZE_SIG)!=0)
 {
 	M_ERROR(NOT_CSF);
 	goto error_open;
 }
